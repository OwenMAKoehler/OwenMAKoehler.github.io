...
### [4-DOF Robotic Arm](https://owenmakoehler.github.io/projects/robotic-arm.html)
*Independent project · Apr – Aug 2026*

A 3D-printed desktop robotic arm built for under $200, with a 270 mm reach, ~500 g payload, and ~1 mm repeatability.
- Custom cycloidal reducers on NEMA 17 steppers for high reduction with low backlash
- Modular, bearing-supported joint actuators and a servo-driven compliant gripper
- Modified GRBL firmware so the steppers and gripper share one G-code stream
- A browser-based controller with a live 3D model, joint jogging, XYZ inverse kinematics, and recorded
...
- **CAD & Software:** SolidWorks (CSWA), Fusion 360, AutoCAD, C++ (Arduino), MATLAB
